  ...
  return (
    <div className='flex justify-between mt-28'>
      <div className='max-w-1/4 shadow-sm/30 h-[250px] shadow-gray-300 rounded-md hover:scale-102 transition-all cursor-pointer flex flex-col gap-3 p-3 shadow-black/30'>
        ...
        <p className='font-semibold text-xl  text-blue-600 ' >ATS Score Analysis</p>
       <div> <p className=' text-white ' >Get instant feedback on how well
...
AI algorithm</p></div>
      ...
      <div  className='max-w-1/4 shadow-sm/30 h-[250px] shadow-gray-300 rounded-md hover:scale-102 transition-all cursor-pointer flex flex-col gap-3 p-3 shadow-black/30'>
        ...
        <p className='font-semibold text-xl text-blue-600 '>Skills Extraction</p>
        <div><p className=' text-white' >Automatically identify and extract
...
resume to highlight your strengths.</p></div>
      ...
      <div  className='max-w-1/4 shadow-sm/30 h-[250px] shadow-gray-300  rounded-md hover:scale-102 transition-all cursor-pointer flex flex-col gap-3 p-3 shadow-black/30'>
        ...
        <p className='font-semibold text-xl text-blue-600'>improvement Tips</p>
        <div><p className=' text-white ' >Receive personalized suggestions to
